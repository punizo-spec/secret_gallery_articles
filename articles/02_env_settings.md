...
ガンガン先に進めたい人は、飛ばして大丈夫！
だけど、入門ぷに蔵が最初にハマったポイントだったので、一度整理しておくね。

初っ端から当然のように「プロジェクトがー」「プロジェクトでー」「プロジェクトをー」とか言ってるけど、「なんだよプロジェクトって！！！」って思うよなー笑
...
でも実は、Django で使う「アプリ」という言葉は、スマホアプリとかWebアプリとかの「アプリ」ではない意味で使ってるの！
Django の中では、ログイン機能とか作品管理のような**機能ごとのパーツ**のことをアプリと呼んでいるのね。
つまり Django の独自用語。
ややこし笑
...
- これは「アプリ」を開始したから、プロジェクトの中の機能のひとつを作ろうとしているんだな
